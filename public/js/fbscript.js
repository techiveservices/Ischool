...
var callback = function (e){ 
    ...
    //	alert("No Flash Supported");
    	...
    	if('flipbuilder_hasMobile'=='flipbuilder_'+'hasMobile'){
    		...
    		delayToShowVersion(url('/files/mobile_html'))
    		...
    		delayToShowVersion(url('/files/basic_html'));
    ...
    if(hasMobileVersion){
    	...
    	var pageIndex=getURLParam('pageIndex');
		  ...
		  if(!pageIndex){
		      ...
		      window.location = url('/files/mobile_html')+(window.location.hash?window.location.hash:'');

		   }else{

		   		window.location = url('/files/basic_html')+pageIndex;
			 ...
			 window.location =url('/files/basic_html');
	...
	if(BR.isMobile){
		...
		if(hasMobileVersion){
	 		...
	 		if(pageIndex!=-1){
	 			...
	 			window.location = url('/files/basic_html')+"#p="+pageIndex;
		...
		if(loadType==2){
			...
			if(hasMobileVersion){
		 		...
		 		if(pageIndex!=-1){
		 			...
		 			window.location = url('/files/mobile_html')+"#p="+pageIndex;

		 		}else{

		 			window.location = url('/files/basic_html')+(window.location.hash?window.location.hash:'');
