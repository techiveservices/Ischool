...
?>
 ...
 $sqlQuery = "SELECT * FROM book_issue_to_member WHERE school_id='$new->school_id' and book_id='$new->ebook_id' and issue_till>='$current_date'";

$result = DB::select(DB::raw($sqlQuery));

    echo   $licence_alloted_no= count($result);
