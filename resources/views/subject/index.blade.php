          ...
          <div class="modal-dialog" style="width:60%;">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"></h3>
                  <form method="POST" enctype="multipart/form-data" action="{{ url('/subject_master/add_subject')}}">
...
<!-- 
                  <br>
         <a href="{{url('/subject_master/delete_subject/'.$new->id)}}">
              ...
              @if($user_type=='1')
                 ...
                 @if($new->status=='0')
                 <a href="{{url('/subject_master/activate_subject/'.$new->id.'/1')}}">
                  @else
                 <a href="{{url('/subject_master/activate_subject/'.$new->id.'/0')}}">
                  @endif
        ...
        <div class="modal fade modal-default" id="modal-default_edit_<?php  echo $new->id;     ?>">
          <div class="modal-dialog">
            ...
            <div class="box-header with-border">
              <h3 class="box-title"></h3>
                 <form method="POST" enctype="multipart/form-data" action="{{ url('/subject_master/edit_subject')}}">
                  
         @csrf

         <div class="row">
        <?php  $subject_info=\App\Subject::find($new->id) ;  ?>
               
               <input type="hidden" name="id" class="form-control" value="{{$subject_info->id}}">
               
          <div class="col-md-12">
           <div class="form-group">
           <label style="width:100%;">Subject:</label>
<input type="text" name="name" class="form-control" value="{{$subject_info->name}}">
